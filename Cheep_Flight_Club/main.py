# #100days of code - day 39-40 - Flight Finder with Flight Club
...
for destination in sheety_data:
    ...
    if flight is not None:
        ...
        if flight.price < destination["lowestPrice"]:
            ...
            emails_names = [(row["email"], row["firstName"]) for row in users]
            ...
            notification_manager.send_email(
                ...
                link=flight.link,
                add_msg=additional_message,
                emails=emails,
                emails_names=emails_names
            )
